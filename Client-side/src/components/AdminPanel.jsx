  ...
  return (
    <div className="container">
      ...
      <div className="toolbar mb-3">
        <button className="btn btn-danger me-2" onClick={() => handleUpdateStatus('blocked')}>Block</button>
        <button className="btn btn-secondary me-2" onClick={() => handleUpdateStatus('active')}>Unblock</button>
